...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url()?>assets/template_admin/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="<?= base_url()?>assets/template_admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  <!-- DataTables -->
