  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021-2022 <a href="https://adminlte.io">Perpus-XII</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?= base_url()?>assets/template_admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?= base_url()?>assets/template_admin/bower_components/raphael/raphael.min.js"></script>
<script src="<?= base_url()?>assets/template_admin/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="<?= base_url()?>assets/template_admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?= base_url()?>assets/template_admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="<?= base_url()?>assets/template_admin/dist/js/pages/dashboard.js"></script>
