            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-lg-offset-1">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="tgl_kembali" class="control-label">Tanggal Buku diKembalikan</label>
                  <div><?php echo $db->tgl_kembalikan ?></div>
                  </div>

                  <div class="form-group">
                    <label for="tgl_kembali" class="control-label">Status</label>
              ...
              <div class="box-footer">
                <a href="<?= base_url() ?>siswa/kembali_bacaan" class="btn btn-warning">Cancel</a>
              </div>
            </form>
         </div>
    </div>
