...
<div class="content-wrapper">
    ...
    <?php 
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?= base_url('siswa/pinjam_bacaan/tambah_bacaan_aksi'); ?>"  class="form-horizontal" />
            <div class="box-body">
            <div class="row">
              ...
              <div class="col-lg-4 col-lg-offset-1">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group" hidden>
                    <input type="text" class="form-control" name="id_jenis" id="id_jenis"  value="1">
                  </div>
              ...
              <div class="box-footer">
                <a href="<?= base_url() ?>siswa/pinjam_bacaan" class="btn btn-warning">Cancel</a>
    ...
    <script>
      $('#id_buku').change(function(){
        var id = $(this).val();
        $.ajax({
          url: '<?= base_url()?>siswa/pinjam_bacaan/jumlah_buku',
          data:{id:id},
          method:'post',
          dataType:'json',
