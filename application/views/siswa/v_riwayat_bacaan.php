...
<!-- Main content -->
    ...
    <div class="row">
      <div class="col-md-12">
      <a href="<?= base_url()?>siswa/pinjam_bacaan/tambah_bacaan" class="btn btn-success"><i class="fa fa-plus"></i> Pinjam Buku Bacaan</a>
    </div>
    </div>
    <br>
                    ...
                    ?>
                       ...
                       <?php $tr->id_transaksi ?>
                        ...
                        <?php if($tr->status_transaksi == "disetujui" ) { ?>
                          <a href="<?= base_url()?>siswa/pinjam_bacaan/kembalikan_bacaan/<?= $tr->id_transaksi; ?>" class="btn btn-primary btn-xs" onclick="return confirm('Yakin mau dikembalikan?')">kembalikan</a>
                        <?php } ?>
                          <a href="<?= base_url()?>siswa/pinjam_bacaan/lihat_bacaan/<?= $tr->id_transaksi; ?>" class="btn btn-success btn-xs">detail</a>
                          <?php if($tr->status_transaksi !== "disetujui") { ?>
                            <a href="<?= base_url()?>siswa/pinjam_bacaan/hard_delete/<?= $tr->id_transaksi; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin mau dihapus?')">hapus</a>
                          <?php } ?>
                          </td>
                      </tr>
                      <?php } 
