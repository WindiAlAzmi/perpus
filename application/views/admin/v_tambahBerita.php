...
<div class="content-wrapper">
    ...
    <?php 
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?= base_url(); ?>admin/berita/tambah_berita_aksi" class="form-horizontal">
              <div class="box-body">

              <div class="form-group">
                <label for="id" class="col-sm-2  control-label">Kode Berita</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?= $id_berita; ?>" id="id" name="id" readonly>
                </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" name="isi" id="isi" style="height:200px;"></textarea>
