<div class="content-wrapper">
    ...
    <?php 
          ...
          <div class="box box-info">
            ...
            <form method="post" action="<?= base_url(); ?>admin/buku/update_buku_aksi" class="form-horizontal">
              <div class="box-body">
              <div class="row">
               ...
               <div class="col-lg-4 col-lg-offset-1">
                 <div class="form-group">
                   <label for="tahun" class="control-label">Tahun</label>
                     <input type="text" class="form-control" name="tahun" id="tahun" placeholder="tahun" value="<?= $db->tahun ?>">
