<div class="content-wrapper">
    ...
    <?php 
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?= base_url('admin/buku/tambah_buku_paket_aksi'); ?>"  class="form-horizontal" />
            <div class="box-body">
            <div class="row">
              <div class="col-lg-5 col-lg-offset-1">
                <div class="form-group">
                    <label for="id" class="control-label">Kode</label>
                    <input type="text" class="form-control" value="<?= $id_buku_paket; ?>" id="id" name="id" readonly>
                  </div>
              ...
              <div class="col-lg-4 col-lg-offset-1">
                ...
                <div class="form-group" hidden>
                  <label for="id_jenisBuku" class="control-label">Jenis Buku</label>
                    <input type="number" class="form-control" name="id_jenisBuku" id="id_jenisBuku"   value="2">
                </div>
