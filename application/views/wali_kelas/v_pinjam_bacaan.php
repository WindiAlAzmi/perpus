...
<!-- Main content -->
                   ...
                   foreach($transaksi as $tr){ 
                    ...
                    ?>
                       ...
                       <?php $tr->id_transaksi ?>
                        ...
                        <td>
                          <a href="<?= base_url()?>wali_kelas/pinjam_bacaan/lihat_bacaan/<?= $tr->id_transaksi; ?>" class="btn btn-success btn-xs">detail</a>
                          </td>
                      </tr>
                      <?php } 
                    ?>
  ...
  <script>
    $('.status_transaksi').change(function(){
      ...
      $.ajax({
        url:"<?= base_url()?>wali_kelas/pinjam_bacaan/update_status",
        method:"post",
