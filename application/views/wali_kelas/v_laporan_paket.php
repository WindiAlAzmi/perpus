<section class="content">
    <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?= base_url(); ?>wali_kelas/laporan/peminjaman_paket" class="form-horizontal">
              <div class="box-body ">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <a href="<?= base_url()?>wali_kelas/laporan/cetak_laporan_paket" class="btn btn-sm btn-success" style="margin-left:-50px;"  target="_blank">Cetak Data</a>
                </div>
