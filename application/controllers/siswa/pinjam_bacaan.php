...
class Pinjam_bacaan extends CI_Controller{
    ...
    public function index(){
        ...
        $this->load->view('siswa/v_riwayat_bacaan',$data);
    ...
    public function tambah_bacaan(){
        ...
        $this->load->view('template_admin/header', $data);
        $this->load->view('template_admin/sidebar',$data);
        $this->load->view('siswa/v_tambah_bacaan',$data);
        $this->load->view('template_admin/footer');
    }


    public function tambah_bacaan_aksi(){
        //validasi 
      ...
      public function lihat_bacaan($id_transaksi)
      {
          ...
          $this->load->view('template_admin/header', $data);
          $this->load->view('template_admin/sidebar',$data);
          $this->load->view('siswa/v_lihatBacaan',$data);
          $this->load->view('template_admin/footer');
      }
  
      public function kembalikan_bacaan($id_transaksi)
      {
